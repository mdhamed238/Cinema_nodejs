export default ({ onSubmit, onClick, href }) => {
    return (
        <section className="max-w-xl mt-12 mx-auto px-4">
            ...
            <div className="mt-5">
                ...
                <p className="mt-3 mx-auto text-center max-w-lg text-[15px] text-gray-400">
                    No spam ever, we care about protecting your data.
                    Read our <a className="text-indigo-600 underline" href={href}> Privacy Policy </a>
                </p>
            </div>
        </section>
    )
